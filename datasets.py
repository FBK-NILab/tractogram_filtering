...
class HCP20Dataset(gDataset):
    ...
    def getitem(self, idx):
        ...
        trk_dir = os.path.join(self.root_dir,'derivatives/streamlines_resampled_16', 'sub-%s' % sub)
        T_file = os.path.join(trk_dir, 'sub-%s_var-HCP-resampled_full_tract.trk' % (sub))
